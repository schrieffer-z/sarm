...
def main(args: argparse.Namespace) -> None:
    ...
    if args.judge_model.count('/')>=2:
        st = args.judge_model[:args.judge_model.rfind('/')].rfind('/')
        file_path = f"{dataset_name},judge_name={args.judge_name},judge_model={args.judge_model[st+1:].replace('/', '_')}.jsonl"
