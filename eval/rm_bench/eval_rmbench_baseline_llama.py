...
from sarm_llama import LlamaBaseline

sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
from utils import convert_robust_dataset_to_preference_dataset_list, load_eval_dataset, compute_accuracy
...
def main():
    ...
    model_name = os.path.normpath(args.model)
    acc_dict["model"] = model_name[model_name.rfind('/')+1:]
    with open(os.path.join(args.model, 'rm_bench.json'), 'w') as f:
